...
public class send_msg extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("accepting checkout by all users, the proccess starts.");
        ...
        jLabel2.setText("We sent a message to other users, after");

        jButton1.setBackground(new java.awt.Color(16, 81, 151));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(send_msg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
